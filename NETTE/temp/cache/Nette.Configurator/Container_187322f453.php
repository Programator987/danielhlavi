<?php
// source: /home/uzivatel/projects/NETTE/app/config/config.neon 
// source: /home/uzivatel/projects/NETTE/app/config/config.local.neon 

class Container_187322f453 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Forms\SignInFormFactory' => [1 => ['24_App_Forms_SignInFormFactory']],
			'App\Forms\SignUpFormFactory' => [1 => ['25_App_Forms_SignUpFormFactory']],
			...
			'App\Presenters\CeskafotbalovaligaPresenter' => [1 => ['application.1']],
			'App\Presenters\SignPresenter' => [1 => ['application.2']],
			'App\Presenters\danPresenter' => [1 => ['application.3']],
			'App\Presenters\ErrorPresenter' => [1 => ['application.4']],
			'App\Presenters\HlavickaPresenter' => [1 => ['application.5']],
			'App\Presenters\DanielPresenter' => [1 => ['application.6']],
			'App\Presenters\RandoPresenter' => [1 => ['application.7']],
			'App\Presenters\HomepagePresenter' => [1 => ['application.8']],
			'App\Presenters\Error4xxPresenter' => [1 => ['application.9']],
			'App\Presenters\PracePresenter' => [1 => ['application.10']],
			'App\Presenters\PrijmeniPresenterIN' => [1 => ['application.11']],
		...
		'services' => [
			...
			'24_App_Forms_SignInFormFactory' => 'App\Forms\SignInFormFactory',
			'25_App_Forms_SignUpFormFactory' => 'App\Forms\SignUpFormFactory',
			'26_App_Model_UserManager' => 'App\Model\UserManager',
			'application.1' => 'App\Presenters\CeskafotbalovaligaPresenter',
			'application.10' => 'App\Presenters\PracePresenter',
			'application.11' => 'App\Presenters\PrijmeniPresenterIN',
			...
			'application.3' => 'App\Presenters\danPresenter',
			'application.4' => 'App\Presenters\ErrorPresenter',
			'application.5' => 'App\Presenters\HlavickaPresenter',
			'application.6' => 'App\Presenters\DanielPresenter',
			'application.7' => 'App\Presenters\RandoPresenter',
			'application.8' => 'App\Presenters\HomepagePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/home/uzivatel/projects/NETTE/app',
			'wwwDir' => '/home/uzivatel/projects/NETTE/www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/home/uzivatel/projects/NETTE/app/../temp',
		];
	}
	...
	public function createService__24_App_Forms_SignInFormFactory(): App\Forms\SignInFormFactory
	{
		$service = new App\Forms\SignInFormFactory($this->getService('23_App_Forms_FormFactory'), $this->getService('security.user'));
		return $service;
	}


	public function createService__25_App_Forms_SignUpFormFactory(): App\Forms\SignUpFormFactory
	{
		$service = new App\Forms\SignUpFormFactory($this->getService('23_App_Forms_FormFactory'), $this->getService('26_App_Model_UserManager'));
		return $service;
	}
	...
	public function createServiceApplication__1(): App\Presenters\CeskafotbalovaligaPresenter
	{
		$service = new App\Presenters\CeskafotbalovaligaPresenter;
	...
	public function createServiceApplication__10(): App\Presenters\PracePresenter
	{
		$service = new App\Presenters\PracePresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__11(): App\Presenters\PrijmeniPresenterIN
	{
		$service = new App\Presenters\PrijmeniPresenterIN;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__2(): App\Presenters\SignPresenter
	{
		$service = new App\Presenters\SignPresenter(
			$this->getService('24_App_Forms_SignInFormFactory'),
			$this->getService('25_App_Forms_SignUpFormFactory')
		);
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__3(): App\Presenters\danPresenter
	{
		$service = new App\Presenters\danPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__5(): App\Presenters\HlavickaPresenter
	{
		$service = new App\Presenters\HlavickaPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__6(): App\Presenters\DanielPresenter
	{
		$service = new App\Presenters\DanielPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__7(): App\Presenters\RandoPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/uzivatel/projects/NETTE/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/uzivatel/projects/NETTE/app/../temp/cache');
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_187322f453 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/uzivatel/projects/NETTE/app/../temp/cache/latte');
